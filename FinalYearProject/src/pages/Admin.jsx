    ...
    <div>

      {
        ...
        <form onSubmit={handleLogin} className='grid grid-cols-1 gap-3 bg-white w-[80vw] md:w-[20vw] p-3 rounded-lg'>
          ...
          <button 
          type='submit' className='bg-purple-500 rounded-2xl px-3 py-1 text-gray-100 font-semibold hover: 
          bg-purple-600 transition-all duration-300 ease-in-out'>Login</button>
        </form>
      </div> ): (
      <div>
          <AdminNavbar/>
